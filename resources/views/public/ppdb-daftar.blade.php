    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-md-9" data-aos="fade-up">
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden stagger-item">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <form action="{{ route('ppdb.store') }}" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 stagger-item" style="transition-delay: 0ms;" data-aos="fade-right" data-aos-delay="100">
                                ...
                                <div class="col-md-6 stagger-item" style="transition-delay: 60ms;" data-aos="fade-left" data-aos-delay="100">
                                ...
                                <div class="col-md-6 stagger-item" style="transition-delay: 120ms;" data-aos="fade-right" data-aos-delay="150">
                                ...
                                <div class="col-md-6 stagger-item" style="transition-delay: 180ms;" data-aos="fade-left" data-aos-delay="150">
                                ...
                                <div class="col-md-6 stagger-item" style="transition-delay: 240ms;" data-aos="fade-right" data-aos-delay="200">
                                ...
                                <div class="col-md-6 stagger-item" style="transition-delay: 300ms;" data-aos="fade-left" data-aos-delay="200">
                                ...
                                <div class="col-12 stagger-item" style="transition-delay: 360ms;" data-aos="fade-up" data-aos-delay="250">
                                ...
                                <div class="col-md-6 stagger-item" style="transition-delay: 420ms;" data-aos="fade-right" data-aos-delay="300">
                                ...
                                <div class="col-md-6 stagger-item" style="transition-delay: 480ms;" data-aos="fade-left" data-aos-delay="300">
                                ...
                                <div class="col-md-6 stagger-item" style="transition-delay: 540ms;" data-aos="fade-right" data-aos-delay="350">
                            ...
                            <div class="mt-4 pt-3 border-top d-flex gap-3 align-items-center justify-content-end stagger-item" style="transition-delay: 600ms;" data-aos="fade-up" data-aos-delay="400">
