...
@section('content')
<div class="py-5 bg-white position-relative overflow-hidden section-reveal">
    <div class="container py-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-5 text-center stagger-item" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="col-lg-7 stagger-item" style="transition-delay: 150ms;" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                ...
                <div class="row g-3 mb-2">
                    <div class="col-sm-4 stagger-item" style="transition-delay: 200ms;" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <div class="col-sm-4 stagger-item" style="transition-delay: 260ms;" data-aos="zoom-in" data-aos-delay="400">
                        <div class="p-4 bg-light rounded-4 border-0 card-hover text-center h-100">
                            <div class="fw-extrabold fs-2 text-success mb-1">50+</div>
                            <span class="text-muted small fw-semibold">Tenaga Pengajar</span>
                        </div>
                    </div>
                    <div class="col-sm-4 stagger-item" style="transition-delay: 320ms;" data-aos="zoom-in" data-aos-delay="500">
                        <div class="p-4 bg-light rounded-4 border-0 card-hover text-center h-100">
...
<div class="py-5 bg-light">
    <div class="container py-5">
        <div class="text-center mb-5" data-aos="fade-up">
            <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill fw-semibold mb-2 stagger-item">Arah Pedoman</span>
            <h2 class="fw-bold display-6 stagger-item" style="transition-delay: 80ms;">Visi dan Misi Sekolah</h2>
            <p class="text-muted mx-auto stagger-item" style="max-width: 500px; transition-delay: 160ms;">Landasan utama kami dalam mencetak lulusan yang berdaya saing tinggi.</p>
        </div>
        <div class="row g-4">
            ...
            <div class="col-md-6 stagger-item" style="transition-delay: 120ms;" data-aos="fade-left" data-aos-delay="200">
                <div class="card border-0 shadow-sm card-hover h-100 rounded-4 overflow-hidden">
                    <div class="card-body p-4 p-lg-5">
                        <div class="d-flex align-items-center gap-3 mb-4">
